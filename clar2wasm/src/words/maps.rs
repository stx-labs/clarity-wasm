...
fn traverse_storage_operation(
    ...
    let (key_offset, key_size) = generator.create_call_stack_local(builder, &key_ty, true, false);
    ...
    let (val_offset, size) = generator.create_call_stack_local(builder, &value_type, true, false);
