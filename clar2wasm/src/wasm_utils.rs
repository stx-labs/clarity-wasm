...
use clarity::vm::errors::{RuntimeCheckErrorKind, VmExecutionError, WasmError};
...
use wasmtime::{AsContextMut, Instance, Linker, Memory, Module, Store, Val, ValType};
...
fn pass_argument_to_wasm(
    ...
    offset: i32,
    in_mem_offset: i32,
) -> Result<(Vec<Val>, i32, i32), VmExecutionError> {
    match value {
        Value::UInt(n) => {
