...
(module
    ...
    (import "clarity" "with_ft" (func $stdlib.with_ft (param $asset_identifier_offset i32)
                                                                    (param $asset_identifier_length i32)
                                                                    (param $allowance_offset i32)
                                                                    (param $allowance_length i32)))
    (import "clarity" "with_nft" (func $stdlib.with_nft (param $asset_identifier_offset i32)
                                                                     (param $asset_identifier_length i32)
                                                                     (param $allowance_offset i32)
                                                                     (param $allowance_length i32)))
    (import "clarity" "with_stacking" (func $stdlib.with_stacking (param $allowance_offset i32)
                                                                              (param $allowance_length i32)))
    (import "clarity" "with_stx" (func $stdlib.with_stx (param $allowance_offset i32)
                                                                     (param $allowance_length i32)))
