...
(module
    ...
    (import "clarity" "with_ft" (func $stdlib.with_ft (param $contract_id_offset i32)
                                                      ...
                                                      (param $amount_lo i64)
                                                      (param $amount_hi i64)))
    (import "clarity" "with_nft" (func $stdlib.with_nft (param $contract_id_offset i32)
                                                        (param $contract_id_length i32)
                                                        (param $token_name_offset i32)
                                                        (param $token_name_length i32)
    ...
    (import "clarity" "with_stx" (func $stdlib.with_stx (param $amount_offset i32)
                                                        (param $amount_length i32)))
