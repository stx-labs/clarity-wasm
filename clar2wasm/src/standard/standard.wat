...
(module
    ...
    (import "clarity" "enter_with_all_assets_unsafe" (func $stdlib.enter_with_all_assets_unsafe))
    (import "clarity" "exit_with_all_assets_unsafe" (func $stdlib.exit_with_all_assets_unsafe))
    (import "clarity" "enter_with_ft" (func $stdlib.enter_with_ft (param $asset_identifier_offset i32)
                                                                    (param $asset_identifier_length i32)
                                                                    (param $allowance_offset i32)
                                                                    (param $allowance_length i32)))
    (import "clarity" "exit_with_ft" (func $stdlib.exit_with_ft))
    (import "clarity" "enter_with_nft" (func $stdlib.enter_with_nft (param $asset_identifier_offset i32)
                                                                     (param $asset_identifier_length i32)
                                                                     (param $allowance_offset i32)
                                                                     (param $allowance_length i32)))
    (import "clarity" "exit_with_nft" (func $stdlib.exit_with_nft))
    (import "clarity" "enter_with_stacking" (func $stdlib.enter_with_stacking (param $allowance_offset i32)
                                                                              (param $allowance_length i32)))
    (import "clarity" "exit_with_stacking" (func $stdlib.exit_with_stacking))
    (import "clarity" "enter_with_stx" (func $stdlib.enter_with_stx (param $allowance_offset i32)
                                                                     (param $allowance_length i32)))
    (import "clarity" "exit_with_stx" (func $stdlib.exit_with_stx))
