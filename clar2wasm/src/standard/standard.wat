...
(module
    ...
    (import "clarity" "enter_as_contract_pre_v4" (func $stdlib.enter_as_contract_pre_v4))
    ...
    (import "clarity" "exit_as_contract_post_v4" (func $stdlib.exit_as_contract_post_v4 (param externref) (result i32 i64 i64)))
