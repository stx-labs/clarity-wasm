...
(module
    ...
    (import "clarity" "secp256r1_verify_simple_hash" (func $stdlib.secp256r1_verify_simple_hash
                                                                 ...
                                                                 (param $pk_length i32)
                                                                 (result i32)))
    (import "clarity" "verify_merkle_proof" (func $stdlib.verify_merkle_proof
                                                                 (param $leaf_offset i32)
                                                                 (param $leaf_length i32)
                                                                 (param $root_offset i32)
                                                                 (param $root_length i32)
                                                                 (param $tx_index_lo i64)
                                                                 (param $tx_index_hi i64)
                                                                 (param $tx_count_lo i64)
                                                                 (param $tx_count_hi i64)
                                                                 (param $siblings_offset i32)
                                                                 (param $siblings_length i32)
                                                                 (result i32)))
    (import "clarity" "ed25519_verify" (func $stdlib.ed25519_verify
                                                                 (param $msg_offset i32)
                                                                 (param $msg_length i32)
                                                                 (param $sig_offset i32)
                                                                 (param $sig_length i32)
